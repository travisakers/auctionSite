...
class Membership{
	...
	function validate_user($username, $password){ //takes what user entered in boxes and runs info against database
		...
		} else return "Please enter correct username and password"; //still need to set expiration
